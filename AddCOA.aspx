<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddCOA.aspx.cs" Inherits="AddCOA" %>
                                            ...
                                            <div class="card-body">
                                                <table>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:DropDownList ID="ddlParentAccountNO" runat="server">
                                                            </asp:DropDownList>
                                                        </td>
                                                        <td>
                                                        </td>
                                                    ...
                                                    <td>Account Level</td><td>
                                                        <asp:TextBox ID="txtAccountLevel" runat="server"></asp:TextBox></td><td></td></tr>
                                                    <tr>
                                                        <td>
                                                        </td>
                                                        <td>
