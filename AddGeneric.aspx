<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddGeneric.aspx.cs" Inherits="AddGeneric" %>
                                            ...
                                            <div class="card-body">
                                                <table>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:Button ID="btnGenericSave" runat="server" Text="Save" 
                                                                class="btn btn-primary" onclick="btnGenericSave_Click"
                                                                 />
                                                        </td>
                                                        <td>
                                                        </td>
