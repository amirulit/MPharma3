                                            ...
                                            <div class="card-body">
                                                <table>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtMenuLInk" runat="server"></asp:TextBox>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:DropDownList ID="ddlParetnMenu" runat="server">
                                                            </asp:DropDownList>
                                                        </td>
                                                        <td>
                                                        </td>
                                                     ...
                                                     <tr>
                                                        ...
                                                        <td>
                                                            <asp:Button ID="btnMenuSave" runat="server" Text="Save" class="btn btn-primary" onclick="btnMenuSave_Click"
                                                                 />
                                                        </td>
                                                        <td>
                                                        </td>
                                                ...
                                                <asp:GridView ID="GridView2" runat="server" 
                                                    onrowdeleting="GridView2_RowDeleting" DataKeyNames="ID" 
                                                    onrowdatabound="GridView2_RowDataBound">
                                                    <Columns>
                                                        <asp:ButtonField ButtonType="Button" CommandName="Delete" Text=" [X] Delete"  />
                                                    </Columns>
                                                </asp:GridView>
                                            </div>
                                        </div>
