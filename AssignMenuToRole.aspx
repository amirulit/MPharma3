<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AssignMenuToRole.aspx.cs"
    Inherits="AssignMenuToRole" %>
                                    ...
                                    <div class="page-body">
                                        <div class="card col-md-12 ">
                                            <div class="card-body">
                                                ...
                                                <br />
                                                <asp:Button ID="btnAssignMenuToRole" runat="server" Text="AssignMenuToRole" 
                                                    onclick="btnAssignMenuToRole_Click" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
