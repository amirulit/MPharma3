<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Copy of Sell_2.aspx.cs" Inherits="Sell_2"
                                ...
                                <div class="page-wrapper full-calender">
                                        ...
                                        <div class="card col-md-12">
                                            ...
                                            <asp:GridView ID="GridView1" runat="server" CssClass="gv" AutoGenerateColumns="false"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="MedName" HeaderText="MedicineName" />
                                                    ...
                                                    <asp:BoundField DataField="TotalSellPrice" HeaderText="TotalSellPrice" />
                                                    ...
                                                    <asp:TemplateField HeaderText="Action">
                                                        <ItemTemplate>
                                                            ...
                                                            -->
                                                            <asp:Button ID="btnDelete" runat="server" Text="Delete" CssClass="delete" OnClientClick="return confirm('Are you sure want to delete?');"
                                    ...
                                    id="myPopup">Get full version at mayuri.infospace@gmail.com</span></span></a> &nbsp;
                                                ...
                                                <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <asp:TextBox ID="txtCardNumber" placeholder="Card Number" runat="server"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="5">
                                            ...
                                            <div class="form-group row">
                                                <div class="col-sm-4">
                                                    <asp:Button ID="btnCreateInvoice" runat="server" Text="Update
