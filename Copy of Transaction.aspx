<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Copy of Transaction.aspx.cs" Inherits="Transaction" %>
                                            ...
                                            <div class="card-block">
                                                <table>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:DropDownList ID="ddlAccount" runat="server" CssClass="select2">
                                                            </asp:DropDownList>
                                                        </td>
                                                        <td>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:DropDownList ID="ddlCRCR" runat="server">
