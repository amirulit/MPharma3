<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Cus_InvoiceDetail.aspx.cs"
    Inherits="Cus_InvoiceDetail" %>
                                                ...
                                                <asp:GridView ID="GridView1" runat="server" CssClass="gv" AutoGenerateColumns="false"
                                                    ...
                                                    <Columns>
                                                        <asp:TemplateField HeaderText="Action">
                                                            ...
                                                            <asp:LinkButton runat="server" ID="btnReturn" Text="<i class='fa  fa-info'></i> Return" 
                 CssClass="btn btn-primary return" />

                                                                <asp:Button ID="btnDelete" runat="server" Text="Delete" CssClass="btn btn-danger" OnClientClick="return confirm('Are you sure? want to delete the entry.');"
                                                        ...
                                                        <asp:BoundField DataField="MedicineName" HeaderText="Med Name" />
                                                        <asp:BoundField DataField="Quantity" HeaderText="Qty" />
                                                        <asp:BoundField DataField="SellPrice" HeaderText="U Price" />
                                                        <asp:BoundField DataField="TotalBuyPrice" HeaderText="Tot Buy Price" />
                                                        <asp:BoundField DataField="TotalSellPrice" HeaderText="Tot Sell Price" />
                                                        <asp:BoundField DataField="Discount" HeaderText="Discount" />
                                                        <asp:BoundField DataField="NetReceivable" HeaderText="Net Rec" />
                                                        <asp:BoundField DataField="NetProfit" HeaderText="Net Profit" />
