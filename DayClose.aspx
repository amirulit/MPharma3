<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DayClose.aspx.cs" Inherits="DayClose" %>
                                            ...
                                            <div class="card-block">
                                                <table>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtTransactionDate" runat="server" CssClass="date" placeholder="Tran. Date"
                                                                required=""></asp:TextBox>
                                                        </td>
                                                        <td>
                                                        </td>
                                                    </tr>
                                                    <tr><td colspan="3">Cash Position</td></tr>
                                                    <tr>
                                                        <td>
                                                             &nbsp&nbsp&nbsp (Counter 1)
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="txtCashPositionCounter1" runat="server"></asp:TextBox>
                                                        </td>
                                                        <td>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                            &nbsp&nbsp&nbsp (Counter 2)
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="txtCashPositionCounter2" runat="server"></asp:TextBox>
                                                        </td>
                                                        <td>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtNarration" runat="server" Width="523px"></asp:TextBox>
                                                        </td>
                                                        <td>
                                                        </td>
                                                    </tr>
