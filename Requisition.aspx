<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Requisition.aspx.cs" Inherits="Requisition" %>
...
<li class="">
<a href="view_roles.php">
<span class="pcoded-mtext">Add Medicine Group</span>
</a>
</li
>
<li class="">
                                ...
                                <div class="page-wrapper full-calender">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="page-header-breadcrumb">
                                                    <ul class="breadcrumb-title">
                                                        ...
                                                        <li class="breadcrumb-item"><a>Requsition</a> </li>
                                                        <li class="breadcrumb-item"><a href="addpass.php">Requsition Create</a> </li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="page-body">
                                            ...
                                            <div class="card-body">
                                                    ...
                                                    <table>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:TextBox ID="txtRequisitionDate" runat="server" placeholder="
                                        Date" required=""></asp:TextBox>
                                                        ...
                                                        <td> <asp:DropDownList ID="ddlManufacturer" runat="server"  CssClass="select2" 
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td colspan="3">
                                                                <asp:Button ID="btnRequisition" runat="server" Text="Create Requisition" class="btn btn-primary m-b-0"
                                                                    OnClick="btnRequisition_Click" />
                                                            </td>
                                                        </tr>
                                                    </table>
