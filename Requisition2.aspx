<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Requisition2.aspx.cs" Inherits="Requisition2" %>
                                    ...
                                    <div class="page-body">
                                        ...
                                        Date" required=""></asp:TextBox>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td colspan="2">
                                                                <asp:TextBox ID="txtDrugName" runat="server" Width="306px"></asp:TextBox>
                                                            </td>
                                                            <td>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td colspan="2"> 
                                                                <asp:Button ID="btnNewReq" runat="server" Text="Save"  class="btn btn-primary" 
                                                                    onclick="btnNewReq_Click"/>
