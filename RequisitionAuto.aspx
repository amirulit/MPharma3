<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RequisitionAuto.aspx.cs"
    Inherits="RequisitionAuto" %>
                                ...
                                <div class="page-wrapper full-calender">
                                    ...
                                    <div class="page-body">
                                        <div class="col-md-12">
                                            <div class="card">
                                                <div class="card-body">
                                                    <input id="Button1" type="button" value="View Requistion" onclick="Open();" />
                                                    <br />
                                                    Manufacturer Name :
                                                    ...
                                                    <br />
                                                    <br />
                                                    <asp:GridView ID="GridView2" runat="server" ShowHeaderWhenEmpty="true" CssClass="table table-responsive">
                                                        <Columns>
                                                            ...
                                                            <asp:Button ID="btnEdit" runat="server" Text="Edit" CssClass="gridbtn" OnClick="btnEdit_Click" />
                                                                    ...
                                                                    <a href="#" data-qty='<%#Eval("Present_Quantity") %>' data-id='<%#Eval("ID") %>'
                                                                        class="update btn btn-primary"><i class='fa fa-edit'></i>Update</a>
                    ...
                    <div class="modal-body">
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtPresentQTY" runat="server"></asp:TextBox>
                                </td>
                                <td>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtREQ_QTY" runat="server"></asp:TextBox>
                                </td>
                                <td>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <input id="btnUpdate" type="button" value="Save New Requirement" cssclass="btn btn-primary" />
                                </td>
                                <td>
                                </td>
                            </tr>
    ...
    <script type="text/javascript">
        ...
        function getMedicineInfo(ID) {
            ...
            $.ajax({
                ...
                //url: loc + "/CheckUserName",
                //url: loc + "/AAA",
                url: "RequisitionAuto.aspx/getStockDetail",
        ...
        function SaveNewQty(ID) {
            ...
            $.ajax({
                ...
                //url: loc + "/CheckUserName",
                //url: loc + "/AAA",
                url: "RequisitionAuto.aspx/SaveNewQuantity_Required",
                //data: '{eid: ' + id + '}',
                //data: "{'ID' : ID,'MedName': NewMedName, 'Strength' : NewStrength , 'GenericName' : NewGenericName  }",
                data: JSON.stringify({ ID: ID, NEW_QTY: NewReqQty }),
                //data: JSON.stringify({ ID:ID }),
                //data: '{"ID":"' + ID + '"}',
                //data: "{}",
     ...
     <script type="text/javascript">
         function Open() {
             ...
             var ComName = document.getElementById('DropDownList1').value;

             var url = "RequistionRep.aspx?ComName=" + ComName;
