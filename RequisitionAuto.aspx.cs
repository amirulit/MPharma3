...
public partial class RequisitionAuto : System.Web.UI.Page
{
    ...
    [WebMethod()]
    public static string SaveNewQuantity_Required(Int32 ID,  String NEW_QTY)
    {
        String Out = String.Empty;
        /*
     ...
     SET [MedicineName] = '" + MedName + "' , [Strength] ='" + Strength + "' ,[GenericName] ='" + GenericName + "' ,[ProductType]='" + MedicineType + "'  WHERE ID= " + ID;
        ...
        try
        {
            ...
            command.CommandText = "insert into dbo.t_Requisition values (" + ID + "," + NEW_QTY + ",'','Tuhen',GETDATE())";
            command.Connection = connection;
...
from 
    ...
    [WebMethod()]
    public static string getStockDetail(Int32 ID)
    {
        //return "100";
    ...
    {
        //String ComName = DropDownList1.SelectedValue.ToString();
