...
public partial class SellManage : System.Web.UI.Page
{
    ...
    protected void GetSellInfo(String fdt, String tdt)
    {
        ...
        String SqlStr = @" Select 
                            '<a class=''btn btn-primary'' href=javascript:OpenWin('''+s.InvoiceNO+''')>'+s.InvoiceNO+'</a>' InvoiceNO
                            ,'<a class=''btn btn-info'' href=javascript:OpenWin2('''+s.InvoiceNO+''')>'+s.InvoiceNO+'</a>'  Sel
                            ,s.InvoiceNO
                            ,s.Qty
                            ,s.Tot_Sell_Price
                            ,s.Tot_Discount
                            ,s.Tot_Receivable
                            ,s.NetProfit-i.TotalDiscount NetProfit
                            ,isnull(i.NetAmount,0)  NetReceived
