...
public partial class Sell : System.Web.UI.Page
{
            ...
            SqlParameter[] parameters = 
                    {
                        ...
                        new SqlParameter("@ProductCode", txtProductID.Text ), 
                        new SqlParameter("@Quantity",  txtQuantity.Text), 
                        new SqlParameter("@Price",txtTotalPrice.Text.Trim()), 
    ...
    private void GetSaleInfo(String InvNO)
    {
        ...
        SqlCommand cmd = new SqlCommand("Select (Select MedicineName from t_Medicine  where ID=s.ProductCode) ProductName,* from [MPharma].[dbo].[t_Sell]  s where InvoiceNO='" + InvNO + "'", connection);
    ...
    protected void btnCreateInvoice_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            */
            ...
            command.Parameters.Add("@InvoiceAmount", SqlDbType.Decimal).Value = txtInvoiceNO.Text.Trim();
