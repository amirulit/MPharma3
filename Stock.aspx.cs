...
public partial class Stock : System.Web.UI.Page
{
    ...
    protected void AddToStock()
    {
        ...
        try
        {
            ...
            command.CommandText = "usp_StockAdd_2";
            command.Connection = connection;
            ...
            SqlParameter[] parameters = 
                    {
                        ...
                        */
                        ...
                        new SqlParameter("@Inputter", Session["UserID"].ToString()),
                        ...
                        new SqlParameter("@TotalTP",   txtTotalTP.Text),
                        new SqlParameter("@SpecialDiscount",txtSpecialDiscount.Text),
                        new SqlParameter("@BuyPriceFactor", txtBuyPriceFactor.Text),

                        new SqlParameter("@TP" ,txtTP.Text),
                        new SqlParameter("@VAT",  txtVAT.Text),
    ...
    protected void btnSaveInvoice_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            command.CommandText = "usp_SaveSupplierInvoice";
            command.Connection = connection;
            ...
            SqlParameter[] parameters = 
                    {
                        ...
                        new SqlParameter("@SpecialDiscount",txtSpecialDiscount.Text),
                        new SqlParameter("@BuyPriceFactor", txtBuyPriceFactor.Text),
                        new SqlParameter("@netAmount",txtNetAmount.Text),
            ...
            if (i > 0)
            {
                ...
                connection.Close();
                Page.ClientScript.RegisterStartupScript(this.GetType(), "Msg", "alert('Invoice Saved Successfully');", true);
                lblStatus.Text = "";
            ...
            {
                connection.Close();
                Page.ClientScript.RegisterStartupScript(this.GetType(), "Msg", "alert('Invoice Not Saved. Duplicate Invoice No');", true);
                lblStatus.Text = "";
            }
