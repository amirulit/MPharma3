<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StockInInvoiceManage.aspx.cs"
    Inherits="StockInInvoiceManage" %>
...
<span class="pcoded-mtext"></i> Logout</span>
                            ...
                            <div class="main-body">
                                <div class="page-wrapper">
                                    ...
                                    <div class="page-body">
                                        <div class="row">
                                            <div class="col-lg-12">
                                             <div class="page-header">   Invoice Summary :</div>
                                                <table>
                                                    <tr>
                                                        <td>
                                                ...
                                                <table id="Table1" class="table-bordered">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="auto-style1">
                                                                <a href="#" class='btn btn-xs btn-info' onclick="javascript:OpenWin('<%=TableData.Rows[data]["InvoiceNO"] %> ');">
    ...
    <script type="text/javascript">
        ...
        function OpenWinStockInvoice(InvoiceNO) {

            var url = "StockInInvoiceDetail.aspx?InvNO=" + InvoiceNO;
