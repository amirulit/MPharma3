...
public partial class StockManageV2 : System.Web.UI.Page
{
    ...
    private void GetStockInInvoiceInfo()
    {
        ...
        String SqlStr = @"Select 
                                Distinct Supplier
                                ,InvoiceNO
                                ,Count( Distinct ProductCode) Product_Type_Count
                                ,Sum(TotalCount) Quantity
                                ,Sum(TotalBuyPrice) TotalBuyPrice 
                        From 
                            t_Stock " + WhereSupplierClause + WhereEntryDateClause + WhereInvoiceNOClause + @" 
                        Group By 
                            Supplier, InvoiceNO 
                        Order By 
                            2 asc";
