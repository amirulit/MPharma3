<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StockStatus_ProductWise.aspx.cs" Inherits="StockStatus_ProductWise" %>
...
<span class="pcoded-mtext"></i> Logout</span>
                                            ...
                                            <div class="col-lg-12">
                                                ...
                                                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false">
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField DataField="GenericName" HeaderText="Gen Name" HtmlEncode="false" />
    ...
    <script type="text/javascript">
        ...
        function OpenWin(ProductCode) {


            //alert(ProductCode);
            var url = "SetSellPrice.aspx?ProductCode=" + ProductCode;
        ...
        function OpenWin2(ProductCode) {

            var url = "InOutHistory.aspx?v=" + ProductCode;
        ...
        function OpenWin3(GenericName) {

            var url = "StockStatus_GenWise.aspx?v=" + GenericName;
